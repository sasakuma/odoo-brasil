...
class TestNFeBrasil(TransactionCase):
    ...
    def setUp(self):
        ...
        self.service_type.codigo_servico_dsf = '07498'
    ...
    @patch('odoo.addons.br_nfse_dsf.models.invoice_eletronic.teste_envio_lote_rps')  # noqa
    ...
    @patch('odoo.addons.br_nfse_dsf.models.invoice_eletronic.cancelamento_nfe')  # noqa
